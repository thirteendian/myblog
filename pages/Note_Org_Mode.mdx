...
<sup><a id="fnr.1" class="footref" href="pages/Note_Org_Mode#fn.1" role="doc-backlink">1</a></sup>
...
<sup><a id="fnr.4" class="footref" href="pages/Note_Org_Mode#fn.4" role="doc-backlink">4</a></sup>
...
<sup><a id="fnr.6" class="footref" href="pages/Note_Org_Mode#fn.6" role="doc-backlink">6</a></sup>
...
<sup><a id="fnr.7" class="footref" href="pages/Note_Org_Mode#fn.7" role="doc-backlink">7</a></sup>, in latex header
...
<sup><a id="fn.1" href="pages/Note_Org_Mode#fnr.1">1</a></sup> There is no need to indicate the first paragraph after title because obviously it's the start of the first paragraph.

<sup><a id="fn.2" href="pages/Note_Org_Mode#fnr.2">2</a></sup> Cycle means "folded-subtree–show all" or "overview–contents–show all"

<sup><a id="fn.3" href="pages/Note_Org_Mode#fnr.3">3</a></sup> Note that there are two columns after inline footnote and two newline after the seperate footnote

<sup><a id="fn.4" href="pages/Note_Org_Mode#fnr.4">4</a></sup> The 's' here is only for SRC environment, to generate other default environment, refer to `C-h v org-structure-template-alist RET`

<sup><a id="fn.5" href="pages/Note_Org_Mode#fnr.5">5</a></sup> The supported language list can be checked at [Babel: Languages](https://orgmode.org/worg/org-contrib/babel/languages/index.html)

<sup><a id="fn.6" href="pages/Note_Org_Mode#fnr.6">6</a></sup> The detail of minted environment options can be referred to CTAN.

<sup><a id="fn.7" href="pages/Note_Org_Mode#fnr.7">7</a></sup> More styles can be refered  to [Pygments Demo](https://pygments.org/demo/)
